...
if($_SERVER['REQUEST_METHOD']=='POST'){               //contains post data for the request methods         
	$id=$_POST['hidden'];
		...
		$q1="select quantityName,price from orders where itemName='$queryname'";   //select query based on where condition to search quantity and price of item for product 1
        $r1=@mysqli_query($dbc,$q1);        //connection to database
...
$q1="update orders SET quantityName=$updatequantity,price=$updateprice where itemName='$queryname'";            // updating the orders table
$r=@mysqli_query($dbc,$q1);

		}
		else{
			$queryname=$_POST['namehidden'];
			$qdel="delete from orders where itemName='$queryname'";       //deleting data from the orders table
	...
	$q= "insert into orders (itemName, quantityName, price, totalprice) values ('$name1', '$quantity1','$price1','$totalprice')";     //inserting data to the orders table
		...
		$quantity2=$_POST['quantity'];
		$queryname=$_POST['namehidden'];
		$q1="select quantityName,price from orders where itemName='$queryname'";      //select query based on where condition to search quantity and price of item for product 2
...
while($row1=mysqli_fetch_array($r1,MYSQLI_ASSOC)){
	...
	$q= "insert into orders (itemName, quantityName, price, totalprice) values ('$name1', '$quantity1','$price1','$totalprice')";
		...
		$quantity2=$_POST['quantity'];
		$queryname=$_POST['namehidden'];
		$q1="select quantityName,price from orders where itemName='$queryname'";  //select query based on where condition to search quantity and price of item for product 3
				                        $r1=@mysqli_query($dbc,$q1);
while($row1=mysqli_fetch_array($r1,MYSQLI_ASSOC)){
							$updatequantity=$quantity2+$row1['quantityName'];
							$updateprice=$updatequantity*$row1['price'];
	...
	$q= "insert into orders (itemName, quantityName, price, totalprice) values ('$name1', '$quantity1','$price1','$totalprice')";
		...
		$quantity2=$_POST['quantity'];
		$queryname=$_POST['namehidden'];
		$q1="select quantityName,price from orders where itemName='$queryname'"; //select query based on where condition to search quantity and price of item for product 4
				                        $r1=@mysqli_query($dbc,$q1);
while($row1=mysqli_fetch_array($r1,MYSQLI_ASSOC)){
							$updatequantity=$quantity2+$row1['quantityName'];
							$updateprice=$updatequantity*$row1['price'];
	...
	$q= "insert into orders (itemName, quantityName, price, totalprice) values ('$name1', '$quantity1','$price1','$totalprice')";
		...
		$quantity2=$_POST['quantity'];
		$queryname=$_POST['namehidden'];
		$q1="select quantityName,price from orders where itemName='$queryname'";    //select query based on where condition to search quantity and price of item for product 5
				                        $r1=@mysqli_query($dbc,$q1);
while($row1=mysqli_fetch_array($r1,MYSQLI_ASSOC)){
							$updatequantity=$quantity2+$row1['quantityName'];
							$updateprice=$updatequantity*$row1['price'];
	...
	$q= "insert into orders (itemName, quantityName, price, totalprice) values ('$name1', '$quantity1','$price1','$totalprice')";
		...
		$quantity2=$_POST['quantity'];
		$queryname=$_POST['namehidden'];
		$q1="select quantityName,price from orders where itemName='$queryname'";  //select query based on where condition to search quantity and price of item for product 6
				                        $r1=@mysqli_query($dbc,$q1);
while($row1=mysqli_fetch_array($r1,MYSQLI_ASSOC)){
							$updatequantity=$quantity2+$row1['quantityName'];
							$updateprice=$updatequantity*$row1['price'];
